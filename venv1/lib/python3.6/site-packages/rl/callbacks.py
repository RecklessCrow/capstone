...
class ModelIntervalCheckpoint(Callback):
    def __init__(self, weights_file, interval, verbose=0):
    ...
    def on_step_end(self, step, logs={}):
        """ Save weights and memory at interval steps during training """
        self.total_steps += 1
        if self.total_steps % self.interval != 0:
            # Nothing to do.
            return

        weights_file = self.weights_file.format(step=self.total_steps, **logs)
        if self.verbose > 0:
