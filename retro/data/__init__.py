...
def get_file_path(game, file, inttype=Integrations.DEFAULT):
    ...
    """
    if game == 'Galaga-Nes':
        return f'/home/cj/PycharmProjects/capstone/gym-retro/retro/data/contrib/Galaga-Nes/{file}'
    elif game == 'DigDug-Nes':
        return f'/home/cj/PycharmProjects/capstone/gym-retro/retro/data/contrib/DigDug-Nes/{file}'
    return None
...
def get_romfile_path(game, inttype=Integrations.DEFAULT):
    ...
    """
    if game == 'Galaga-Nes':
        return '/home/cj/PycharmProjects/capstone/gym-retro/retro/data/contrib/Galaga-Nes/rom.nes'
    elif game == 'DigDug-Nes':
        return '/home/cj/PycharmProjects/capstone/gym-retro/retro/data/contrib/DigDug-Nes/rom.nes'
